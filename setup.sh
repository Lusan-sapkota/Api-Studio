...
echo ""
echo "🌐 Frontend will be available at: http://localhost:56173"
echo "🔧 Backend API will be available at: http://localhost:58123"
echo "📚 API Documentation will be available at: http://localhost:58123/docs"